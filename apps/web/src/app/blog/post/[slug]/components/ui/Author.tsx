...
const AuthorBottomComponent = ({
  ...
  return (
    <Fragment>
      <div className="select-none mt-3 rounded-2xl px-8 py-8 bg-gray-900 text-gray-400">
        <div className="flex flex-wrap items-start sm:flex-nowrap sm:space-x-6">
          ...
          <div>
            <Link
              href={`/about`}
              className="bg-brand-secondary/20 rounded-full py-2 text-sm text-blue-600 flex flex-col"
            >
